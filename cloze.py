...
st.markdown(
    """
교과서, 모의고사 지문 속 문장의 옳은 동사를 고르는 연습할 수 있는 퀴즈입니다. Word(.docx) 파일로 된 지문을 올리세요.
옳은 어법의 동사형을 고르는 "어법형"과 문맥상 흐름에 맞는 의미의 동사를 고르는 "의미형" 두 가지로 퀴즈를 진행할 수 있습니다. 
퀴즈를 풀며 기말고사 대비를 열심히 해봅시다!!
"""
)
